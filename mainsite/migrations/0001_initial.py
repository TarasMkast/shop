    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='imageRel', to='mainsite.goods', verbose_name='Зображення')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='catalog',
            name='mainCatalog',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='MainCatalogRel', to='mainsite.maincatalog', verbose_name='Назва головного каталогу'),
        ),
    ]
