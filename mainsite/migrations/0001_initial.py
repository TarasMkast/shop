    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='UAH', max_digits=9, verbose_name='Ціна')),
                ('details', models.CharField(max_length=99, verbose_name='Характеристики')),
                ('catalog', models.ForeignKey(blank=True, default='', null=True, on_delete=django.db.models.deletion.CASCADE, to='mainsite.catalog', verbose_name='catalog')),
            ],
            options={
                'verbose_name': 'Товар',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='mainsite.goods', verbose_name='Товар')),
            ],
            options={
                'verbose_name': 'Фото',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods', models.ManyToManyField(to='mainsite.Goods')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='auth.user', verbose_name='Користувач')),
                ('goods', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainsite.goods', verbose_name='Товар')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='catalog',
            name='mainCatalog',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainsite.maincatalog', verbose_name='Назва головного каталогу'),
        ),
    ]
